...
void ShowAccessDeniedMessage()
{
    ...
    cout << "You are not allowed to access this feature, please contact the admin" << endl;
}
...
enum enManageUserseOptions { eListUsers = 1, eAddNewUser = 2, eDeleteUser = 3, eUpdateUser = 4, eFindUser = 5, eMainMenu = 6 };
...
void ShowDeleteUserScreen()
{
    ...
    DeleteUserByAccountUserName(UserName, vUsers);
}
...
void PerfromManageUserseOption(enManageUserseOptions ManageUsersOption)
{
    switch (ManageUsersOption)
    {
    case enManageUserseOptions::eListUsers:
    {
        system("cls");
        ShowListUsersScreen();
    ...
    case enManageUserseOptions::eAddNewUser:
        system("cls");
        ShowAddNewUsersScreen();
        GoBackToManageUserScreen();
        break;

    case enManageUserseOptions::eDeleteUser:
        system("cls");
        ShowDeleteUserScreen();
        GoBackToManageUserScreen();
        break;

    case enManageUserseOptions::eUpdateUser:
        system("cls");
        ShowUpdateUserScreen();
        GoBackToManageUserScreen();
        break;

    case enManageUserseOptions::eFindUser:
        system("cls");
        ShowFindUserScreen();
        GoBackToManageUserScreen();
        break;

    case enManageUserseOptions::eMainMenu:
        system("cls");
        ShowMainMenue();
        break;
    }
...
void ShowManageUsersMenue()
{
    ...
    cout << "\t[6] Main Menu.\n";
    cout << "===========================================\n";
    PerfromManageUserseOption((enManageUserseOptions)ReadManageUserseOption());
}
...
bool FinderUserByUserNameAndPassword(string UserName, string Password, sUser& User)
{
    vector <sUser> vUsers = LoadUserDataFromFile(UsersFileName);
...
{
    if (FinderUserByUserNameAndPassword(UserName, Password, CurrentUser))
        return true;
    else
        return false;
}
